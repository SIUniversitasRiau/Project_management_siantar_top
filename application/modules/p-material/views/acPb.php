...
<div class="col-md-12">
    <div class="widget wgreen">
        <div class="widget-head">
            <div class="pull-left">Data List PB</div>
        ...
        <div class="widget-content" style="padding: 10px">
            ...
            <button type="button" class="btn btn-sm btn-primary" onclick="window.location.href= '<?= base_url().$this->uri->segment(1, 0).'/'.$this->uri->segment(2, 0).'/viewNewPb' ?>'"><i class="fa fa-plus fa-fw"></i> Tambahkan PB</button>
            <div class="page-tables">
                <div class="table-responsive">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" id="data-table" width="100%" style="white-space: nowrap">
                        ...
                        <tbody>
                            <?php
                            foreach ($listPb as $key => $item) {
                                $id_bar = $item['PENERIMAAN_BARANG_ID'];
                                ?>
                                <tr id="item_<?php echo $id_bar; ?>">
                                    ...
                                    <td>
                                        <?= $item['PENERIMAAN_BARANG_KODE'] ?>
                                    </td>
                                    <td>
                                        <?= $item['PENERIMAAN_BARANG_NAMA'] ?>
                                    </td>
                                    <td>
                                        <?= $item['LPB_SURAT_JALAN'] ?>
                                    </td>
                                    <td><?= $item['TOTAL'] ?></td>
                                    <td>
                                        <div class="btn-group">
