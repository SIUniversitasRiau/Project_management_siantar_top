                        ...
                        <div class="padd">
                            <form action="<?= base_url().'projects/project/update' ?>" method="post" class="form-horizontal" role="form">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control" name="PROJECT_KODE" placeholder="Kode Proyek" value="<?= $listDetailProject[0]['PROJECT_KODE'] ?>" readonly="true">
                                        <input type="hidden" class="form-control" name="PROJECT_ID" value="<?= $listDetailProject[0]['PROJECT_ID'] ?>" readonly="true">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Nama Proyek</label>
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control" name="PROJECT_NAME" placeholder="Nama Proyek" value="<?= $listDetailProject[0]['PROJECT_NAMA'] ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Deskripsi</label>
                                    <div class="col-lg-5">
                                        <textarea class="form-control" rows="5" name="PROJECT_DESCRIPTION" placeholder="Deskripsi"><?= $listDetailProject[0]['PROJECT_DESCRIPTION'] ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                        <select multiple name="CREATOR[]" id="selectDynamic1" style="width:100%" class="populate">
                                            <?php
                                            $flag= array();
                                            for ($x = 0; $x < sizeof($listDetailProject); $x++) {
                                                if ($listDetailProject[$x]['PENUGASAN_ID'] == 1) {
                                                    $flag[$listDetailProject[$x]['PENGGUNA_ID']]=1;
                                                }
                                            }
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                      <select multiple name="ESTIMATOR[]" id="selectDynamic2" style="width:100%" class="populate">
                                            ...
                                            $flag= array();
                                            for ($x = 0; $x < sizeof($listDetailProject); $x++) {
                                                if ($listDetailProject[$x]['PENUGASAN_ID'] == 2) {
                                                    $flag[$listDetailProject[$x]['PENGGUNA_ID']]=1;
                                                }
                                            }
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                      <select multiple name="PM[]" id="selectDynamic3" style="width:100%" class="populate">
                                            ...
                                            $flag= array();
                                            for ($x = 0; $x < sizeof($listDetailProject); $x++) {
                                                if ($listDetailProject[$x]['PENUGASAN_ID'] == 3) {
                                                    $flag[$listDetailProject[$x]['PENGGUNA_ID']]=1;
                                                }
                                            }
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                      <select multiple name="PP[]" id="selectDynamic4" style="width:100%" class="populate">
                                            ...
                                            $flag= array();
                                            for ($x = 0; $x < sizeof($listDetailProject); $x++) {
                                                if ($listDetailProject[$x]['PENUGASAN_ID'] == 4) {
                                                    $flag[$listDetailProject[$x]['PENGGUNA_ID']]=1;
                                                }
                                            }
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                      <select multiple name="PO[]" id="selectDynamic5" style="width:100%" class="populate">
                                            ...
                                            $flag= array();
                                            for ($x = 0; $x < sizeof($listDetailProject); $x++) {
                                                if ($listDetailProject[$x]['PENUGASAN_ID'] == 5) {
                                                    $flag[$listDetailProject[$x]['PENGGUNA_ID']]=1;
                                                }
                                            }
