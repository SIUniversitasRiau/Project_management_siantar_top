    ...
    <div class="container">
        <div class="row">
			...
			echo "<option value='" . $i['KATEGORI_ANALISA_ID'] . "'>" . $i['KATEGORI_ANALISA_NAMA'] . "</option>";
							...
							<div style="width: 100%" align="center"><button id="add" class="btn btn-primary btn-lg" onclick="simpanAnalisa()">Simpan</button></div>
						</div>
					</div>
...
<script>
	...
	function simpanAnalisa(){
		...
		$.ajax({
			...
			data: {kode: kodeAnalisa, nama: namaAnalisa, barang: dataBarangString, upah: dataUpahString, total: totalAnalisa, satuan: satuanAnalisa, kategori: kategoriAnalisa, lokasi: lokasiAnalisa}, 
			cache: false,
