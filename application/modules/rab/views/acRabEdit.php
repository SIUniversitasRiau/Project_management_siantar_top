    ...
    <div class="container">
        <div class="row">
							...
							<div class="col-lg-12 col-lg-offset-0">
								<div class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-lg-5">
											<input type="text" class="form-control" id="rab_kode" name="rab_kode" placeholder="kode RAB" value="<?= $rab[0]["RAB_KODE"]; ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-1 control-label">Nama</label>
										<div class="col-lg-5">
											<input type="text" class="form-control" id="rab_nama" name="rab_nama" placeholder="nama RAB" value="<?= $rab[0]["RAB_NAMA"]; ?>">
										</div>
									</div>
									<div class="form-group">
			...
			echo "<option ".$selected." value='" . $i['LOKASI_UPAH_ID'] . "'>" . $i['LOKASI_UPAH_NAMA'] . "</option>";
							...
							<div id="btn_container" style="width: 100%; margin-top: 20px" align="center"><button id="add" class="btn btn-primary btn-lg" onclick="simpanRAB(<?= $rab[0]["PROJECT_ID"]; ?>)">Update</button></div>
						</div>
					</div>
...
<script>
	...
	function simpanRAB(project_id){
		...
		$.ajax({
			...
			data: {id: <?= $rab[0]["RAB_ID"]; ?>, kode: kodeRAB, nama: namaRAB, items: rabstring, projectID: project_id, total: rab_total, lokasi: lokasiRAB},
			cache: false,
